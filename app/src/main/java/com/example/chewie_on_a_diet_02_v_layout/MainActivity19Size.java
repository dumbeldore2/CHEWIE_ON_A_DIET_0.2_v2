...
public class MainActivity19Size extends AppCompatActivity {
    ...
    public void click_fun_1(){
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(MainActivity19Size.this, pairs);
        ...
        imageView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (controller()){
                    ...
                    dataBaseRunner.addToTabel5(getIntentId(),getEditView());
    ...
    public int getEditView(){
        int uit = -1;
        uit = Integer.parseInt(editText1.getText().toString().trim());
        return uit;
    }
