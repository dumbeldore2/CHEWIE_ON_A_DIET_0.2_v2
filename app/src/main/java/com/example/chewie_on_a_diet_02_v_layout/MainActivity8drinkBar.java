...
public class MainActivity8drinkBar extends ArrayAdapter<String> {
    ...
    public MainActivity8drinkBar(@NonNull Context c, String s[] ,String s1[] ,String s2[]) {
        super(c,R.layout.activity_main8_bar, R.id.listview_1,s);
        this.context = c;
        this.stringNaam = s;
        this.stringMaker = s1;
        this.stringCal = s2;
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View row = layoutInflater.inflate(R.layout.activity_main8_bar, parent, false);
