...
public class MainActivity4today extends AppCompatActivity {
    ...
    public void click_fun_1(){
        imageView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(MainActivity4today.this, pairs);
